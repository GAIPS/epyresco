...
from .biGV_ns import BiGRUACCriticNS
from .convV_ns import ConvVACCriticNS
...
REGISTRY["bigv_critic_ns"] = BiGRUACCriticNS
REGISTRY["convv_critic_ns"] = ConvVACCriticNS
